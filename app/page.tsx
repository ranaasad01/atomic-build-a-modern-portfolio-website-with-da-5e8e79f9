        ...
        <div className="max-w-6xl mx-auto">
          ...
          >
            ...
            <motion.div variants={fadeInUp} className="mb-16">
              ...
              <p className="text-blue-400 text-xs font-semibold uppercase tracking-widest mb-3">Selected Work</p>
                ...
                >
                  ...
                  <div className="relative h-52 overflow-hidden">
                    ...
                    {project.featured && (
                      ...
                      <span className="absolute top-4 left-4 inline-flex items-center gap-1.5 px-3 py-1 rounded-full bg-blue-500/20 border border-blue-500/30 text-blue-300 text-xs font-medium">
                  ...
                  <div className="p-6">
                    ...
                    <h3 className="font-display text-xl font-bold mb-2 group-hover:text-blue-300 transition-colors duration-300">
        ...
        <div className="max-w-6xl mx-auto">
          ...
          >
            ...
            <motion.div variants={fadeInUp} className="mb-16">
              ...
              <p className="text-blue-400 text-xs font-semibold uppercase tracking-widest mb-3">What I know</p>
        ...
        <div className="max-w-3xl mx-auto">
          ...
          >
            ...
            <motion.div variants={fadeInUp} className="mb-16">
              ...
              <p className="text-blue-400 text-xs font-semibold uppercase tracking-widest mb-3">Career</p>
            ...
            <div className="relative">
              ...
              <div className="absolute left-0 top-2 bottom-2 w-px bg-gradient-to-b from-blue-500/40 via-blue-500/20 to-transparent" />
              ...
              <div className="flex flex-col gap-12 pl-8">
                ...
                {experiences.map((exp) => (
                  ...
                  <motion.div key={exp.id} variants={slideInLeft} className="relative">
                    ...
                    <div className="absolute -left-[2.15rem] top-1.5 w-3 h-3 rounded-full bg-blue-500 border-2 border-[#0f0f0f] shadow-[0_0_10px_rgba(168,85,247,0.6)]" />

                    <p className="text-blue-400/70 text-xs font-medium tracking-widest uppercase mb-1">{exp.period}</p>
        ...
        <div className="max-w-6xl mx-auto">
          ...
          >
            ...
            <motion.div variants={slideInLeft}>
              ...
              <p className="text-blue-400 text-xs font-semibold uppercase tracking-widest mb-3">Who I am</p>
            ...
            <motion.div variants={slideInRight} className="grid grid-cols-2 gap-4">
              ...
              {[
                ...
                >
                  ...
                  <p className="font-display text-3xl font-bold text-blue-400 mb-1">{stat.value}</p>
        ...
        <div className="max-w-2xl mx-auto">
          ...
          >
            ...
            <motion.div variants={fadeInUp} className="text-center mb-12">
              ...
              <p className="text-blue-400 text-xs font-semibold uppercase tracking-widest mb-3">Let&apos;s talk</p>
