...
function SectionLabel({ children }: { children: React.ReactNode }) {
  return (
    <span className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-purple-500/10 border border-purple-500/20 text-purple-400 text-xs font-semibold uppercase tracking-widest mb-4">
      {children}
    </span>
  );
}
...
export default function HomePage() {
  ...
  return (
    <main className="bg-[#0a0a0a] text-white overflow-x-hidden">
        ...
        <div className="relative max-w-6xl mx-auto px-6 pt-32 pb-24 grid md:grid-cols-2 gap-16 items-center">
          ...
          >
            <div className="relative w-full max-w-sm">
              {/* Glow ring */}
              <div className="absolute -inset-4 rounded-3xl bg-gradient-to-br from-purple-600/20 to-indigo-600/10 blur-2xl" />
              <div className="relative rounded-2xl overflow-hidden border border-white/8 shadow-[0_8px_64px_rgba(0,0,0,0.6)]">
                <img
                ...
                />
                {/* Overlay badge */}
                <div className="absolute bottom-4 left-4 right-4 bg-[#0f0f0f]/80 backdrop-blur-xl border border-white/10 rounded-xl px-4 py-3 flex items-center gap-3">
                  <span className="w-2.5 h-2.5 rounded-full bg-emerald-400 shadow-[0_0_8px_rgba(52,211,153,0.8)] flex-shrink-0" />
                  <div>
      ...
      <section className="border-y border-white/5 bg-white/[0.02]">
        ...
        >
          {stats.map((stat) => (
            ...
            >
              <span className="font-display text-4xl md:text-5xl font-bold text-white tracking-tight mb-1">
                {stat.value}
              </span>
            ...
            >
              ...
              <div className="space-y-4">
                {experiences.map((exp, i) => (
                  ...
                  >
                    <span className="absolute left-[-5px] top-1.5 w-2.5 h-2.5 rounded-full bg-purple-500 border-2 border-[#0a0a0a] group-hover:scale-125 transition-transform duration-200" />
      ...
      {/* ── TESTIMONIALS ─────────────────────────────────────────────────── */}
      <section className="py-28 md:py-36 bg-white/[0.015] border-y border-white/5 overflow-hidden">
        <div className="max-w-6xl mx-auto px-6">
          <motion.div
            variants={staggerContainer}
            {...motionProps(staggerContainer)}
          ...
          >
            {testimonials.map((t, i) => (
              ...
              >
                {/* Quote mark */}
                <span className="absolute top-5 right-6 text-purple-500/20 font-display text-6xl leading-none select-none">
                  &ldquo;
                </span>
      ...
      <section id="contact" className="py-28 md:py-36 relative overflow-hidden">
        {/* Background glow */}
        <div className="absolute bottom-0 left-1/2 -translate-x-1/2 w-[600px] h-[400px] rounded-full bg-purple-600/8 blur-[100px] pointer-events-none" />
        ...
        <div className="relative max-w-6xl mx-auto px-6">
          <div className="grid md:grid-cols-2 gap-16 items-start">
                ...
                {[
                  ...
                  >
                    ...
                    <div>
                      ...
                      <p className="text-white text-sm font-medium group-hover:text-purple-300 transition-colors duration-200">
                        {item.value}
                      </p>
                    </div>
                    <ArrowRight
            ...
            <motion.div
              ...
              className="relative"
            >
              <div className="p-8 rounded-2xl border border-white/8 bg-white/[0.03] shadow-[0_8px_48px_rgba(0,0,0,0.4)]">
                {submitted ? (
                  <motion.div
