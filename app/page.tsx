    ...
    <main className="min-h-screen bg-[#0f0f0f] text-white overflow-x-hidden">
      ...
      >
        ...
        >
          ...
          <motion.div variants={fadeInUp} className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full border border-red-500/30 bg-red-500/10 text-red-300 text-xs font-medium tracking-widest uppercase mb-8" style={{ backgroundColor: "#f97316" }} >
          ...
          >
            ...
            <span className="bg-gradient-to-r from-red-400 via-red-400 to-red-600 bg-clip-text text-transparent">
          ...
          >
            ...
            {socials.map(({ icon: Icon, label, href }) => (
              ...
              <a
                ...
                className="w-10 h-10 rounded-full bg-white/5 border border-white/10 flex items-center justify-center text-white/40 hover:text-red-400 hover:border-red-500/40 hover:bg-red-500/10 transition-all duration-300"
        ...
        >
          ...
          <motion.div
            ...
            className="w-px h-8 bg-gradient-to-b from-red-500/60 to-transparent"
        ...
        <div className="max-w-6xl mx-auto">
          ...
          >
            ...
            <motion.div variants={fadeInUp} className="mb-16">
              ...
              <p className="text-red-400 text-xs font-semibold uppercase tracking-widest mb-3">Selected Work</p>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              {projects.map((project, i) => (
                ...
                <motion.article
                  ...
                  className="group relative bg-[#1a1a1a] rounded-2xl overflow-hidden border border-white/5 hover:border-red-500/30 transition-all duration-500 hover:shadow-[0_0_40px_rgba(168,85,247,0.1)]"
                ...
                >
                  ...
                  <div className="relative h-52 overflow-hidden">
                    ...
                    {project.featured && (
                      ...
                      <span className="absolute top-4 left-4 inline-flex items-center gap-1.5 px-3 py-1 rounded-full bg-red-500/20 border border-red-500/30 text-red-300 text-xs font-medium">
                  ...
                  <div className="p-6">
                    ...
                    <h3 className="font-display text-xl font-bold mb-2 group-hover:text-red-300 transition-colors duration-300">
                    ...
                    <a
                      ...
                      className="inline-flex items-center gap-1.5 text-sm font-medium text-red-400 hover:text-red-300 transition-colors duration-200"
        ...
        <div className="max-w-6xl mx-auto">
          ...
          >
            ...
            <motion.div variants={fadeInUp} className="mb-16">
              ...
              <p className="text-red-400 text-xs font-semibold uppercase tracking-widest mb-3">What I know</p>
              ...
              {skills.map((skill) => {
                ...
                return (
                  ...
                  <motion.div
                    ...
                    className="group p-6 rounded-2xl bg-[#1a1a1a] border border-white/5 hover:border-red-500/30 transition-all duration-400 hover:shadow-[0_0_30px_rgba(168,85,247,0.08)]"
        ...
        <div className="max-w-3xl mx-auto">
          ...
          >
            ...
            <motion.div variants={fadeInUp} className="mb-16">
              ...
              <p className="text-red-400 text-xs font-semibold uppercase tracking-widest mb-3">Career</p>
            ...
            <div className="relative">
              ...
              <div className="absolute left-0 top-2 bottom-2 w-px bg-gradient-to-b from-red-500/40 via-red-500/20 to-transparent" />
              ...
              <div className="flex flex-col gap-12 pl-8">
                ...
                {experiences.map((exp) => (
                  ...
                  <motion.div key={exp.id} variants={slideInLeft} className="relative">
                    ...
                    <div className="absolute -left-[2.15rem] top-1.5 w-3 h-3 rounded-full bg-red-500 border-2 border-[#0f0f0f] shadow-[0_0_10px_rgba(168,85,247,0.6)]" />

                    <p className="text-red-400/70 text-xs font-medium tracking-widest uppercase mb-1">{exp.period}</p>
        ...
        <div className="max-w-6xl mx-auto">
          ...
          >
            ...
            <motion.div variants={slideInLeft}>
              ...
              <p className="text-red-400 text-xs font-semibold uppercase tracking-widest mb-3">Who I am</p>
              ...
              <div className="mt-8 flex flex-wrap gap-3">
                ...
                {["Open Source", "Design Systems", "WebGL", "Performance", "Accessibility"].map((tag) => (
                  ...
                  <span
                    ...
                    className="px-3 py-1.5 rounded-full bg-red-500/10 border border-red-500/20 text-red-300 text-xs font-medium"
            ...
            <motion.div variants={slideInRight} className="grid grid-cols-2 gap-4">
              ...
              {[
                ...
                >
                  ...
                  <p className="font-display text-3xl font-bold text-red-400 mb-1">{stat.value}</p>
        ...
        <div className="max-w-2xl mx-auto">
          ...
          >
            ...
            <motion.div variants={fadeInUp} className="text-center mb-12">
              ...
              <p className="text-red-400 text-xs font-semibold uppercase tracking-widest mb-3">Let&apos;s talk</p>
            ...
            >
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
                ...
                <div>
                  ...
                  <input
                    ...
                    className="w-full px-4 py-3 rounded-xl bg-[#1a1a1a] border border-white/8 text-white placeholder-white/20 focus:outline-none focus:border-red-500/50 focus:ring-1 focus:ring-red-500/30 transition-all duration-300 text-sm"
              ...
              <div>
                ...
                <textarea
                  ...
                  className="w-full px-4 py-3 rounded-xl bg-[#1a1a1a] border border-white/8 text-white placeholder-white/20 focus:outline-none focus:border-red-500/50 focus:ring-1 focus:ring-red-500/30 transition-all duration-300 text-sm resize-none"
              ...
              <button
                ...
                className="w-full py-4 rounded-xl bg-red-500 hover:bg-red-400 disabled:opacity-60 disabled:cursor-not-allowed text-white font-semibold text-sm transition-all duration-300 shadow-[0_0_24px_rgba(168,85,247,0.3)] hover:shadow-[0_0_36px_rgba(168,85,247,0.5)] flex items-center justify-center gap-2"
